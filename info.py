...
BOT_TOKEN = environ.get('BOT_TOKEN', '5580813031:AAH_zMUFO3_B2UuxugPL8Hc1S-yq23Sgqw8')
...
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/b0f9f1ad2f6b2bd977805.mp4")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001934019843')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID','-1001919995044')
reqst_channel = environ.get('REQST_CHANNEL_ID','-1001932852728')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '2402a362994b4c9b258f31620597742a2f851595')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', 1))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "10")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "440")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+Ts0na__kpT45ODQ1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/hdhub4u_latest')
MSG_ALRT = environ.get('MSG_ALRT', 'privacy is crime')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001810365326))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'shortnflysupport')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001917422994')).split()]
